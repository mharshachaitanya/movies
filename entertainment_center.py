...
terminator = media.Movie("Terminator" ,
                     "1984 Scifi film",
                     "http://educatinggeeks.com/wp-content/uploads/2014/09/arnold_schwarzenegger_the_terminator_1920x1080_55398.jpg",
                     "http://www.youtube.com/watch?v=-9ceRgWV8io",
                     "Arnold Schwarzenegger",
                     "1984"  )
matrix = media.Movie("Matrix" ,
                     "1999 American-Australian science fiction action film ",
                     "http://www.riskreversal.com/wp-content/uploads/2015/05/matrix_style_by_he4rty-d39qszq.jpg",
...
the_following = media.Movie("The following" ,
                     ...
                     "http://upload.wikimedia.org/wikipedia/en/5/55/Following_film_poster.jpg",
                     "https://www.youtube.com/watch2v=c3sBBRxDAgk",
                     "Jeremy Theobald",
                     "1998")
midnight_in_paris = media.Movie("Midnight in Paris" ,
                     "nostalgic screenwriter finds himself mysteriously going back to the 1920s every day at midnight",
...
movies = [god_father, terminator, matrix, the_following, midnight_in_paris, hunger_games]
