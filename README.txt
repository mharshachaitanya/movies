This directory contains code for Movie listing project
...
fresh_tomatoes.py -- code is updated to include actor, story line and release date. This will generate HTML file
media.py -- Movie class created based on tutorial. 
entertainment_center.py -- this has instances of movies. this will use the above mentioned two classes
